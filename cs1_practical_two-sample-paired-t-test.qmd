...
However, this plot does not capture how the cortisol level of each _individual_ subject has changed though. We can explore the individual changes between morning and evening by looking at the _differences_ between the two times of measurement for each patient.
