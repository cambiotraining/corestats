...
|:---------------|:----------------------|:----------------------------|
| `rstatix`| [`get_summary_stats()`](https://rdrr.io/github/kassambara/rstatix/man/get_summary_stats.html) | Computes summary statistics. |
| `ggResidpanel` | [`resid_panel()`](https://rdrr.io/cran/ggResidpanel/man/resid_panel.html)| Creates diagnostic plots.|
...
source_python("dgplots_knitr.py")
