...
| Functions                       | Description                                                 |
|:-------------------------|:---------------------------------------------|
| [`pingouin.normality()`](https://pingouin-stats.org/generated/pingouin.normality.html)| Perform the Shapiro-Wilk test for normality.|
| [`pingouin.ttest()`](https://pingouin-stats.org/generated/pingouin.ttest.html#pingouin.ttest)| Calculate the T-test for the mean of ONE group of scores.   |
...
We're not focussing on _all_ of the output just yet, but
