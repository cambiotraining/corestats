...
# Performs Levene's test for equality of variance (non-normally distributed data)
rstatix::levene_test()

# Performs Bartlett's test for equality of variance (normally distributed data)
bartlett.test()
